...
class BedokMall extends StatefulWidget {
  const BedokMall({Key? key}) : super(key: key);

  @override
  State<BedokMall> createState() => _BedokMallState();
}

class _BedokMallState extends State<BedokMall> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/bedok_mall.jpg',
                            height: 360,
                            fit: BoxFit.cover,
