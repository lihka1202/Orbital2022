...
class PlazaSingapura extends StatefulWidget {
  const PlazaSingapura({Key? key}) : super(key: key);

  @override
  State<PlazaSingapura> createState() => _PlazaSingapuraState();
}

class _PlazaSingapuraState extends State<PlazaSingapura> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/plaza_singapura.jpg',
                            height: 360,
                            fit: BoxFit.cover,
