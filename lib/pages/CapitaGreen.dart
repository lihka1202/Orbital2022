...
class CapitaGreen extends StatefulWidget {
  const CapitaGreen({Key? key}) : super(key: key);

  @override
  State<CapitaGreen> createState() => _CapitaGreenState();
}

class _CapitaGreenState extends State<CapitaGreen> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/capita_green.jpg',
                            height: 360,
                            fit: BoxFit.cover,
