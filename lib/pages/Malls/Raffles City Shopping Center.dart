...
class RSFC extends StatefulWidget {
  const RSFC({Key? key}) : super(key: key);

  @override
  State<RSFC> createState() => _RSFCState();
}

class _RSFCState extends State<RSFC> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/raffles_city.jpg',
                            height: 360,
                            fit: BoxFit.cover,
