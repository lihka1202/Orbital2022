...
class IMMBuilding extends StatefulWidget {
  const IMMBuilding({Key? key}) : super(key: key);

  @override
  State<IMMBuilding> createState() => _IMMBuildingState();
}

class _IMMBuildingState extends State<IMMBuilding> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/imm.jpg',
                            height: 360,
                            fit: BoxFit.cover,
