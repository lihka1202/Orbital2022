...
class CapitalTower extends StatefulWidget {
  const CapitalTower({Key? key}) : super(key: key);

  @override
  State<CapitalTower> createState() => _CapitalTowerState();
}

class _CapitalTowerState extends State<CapitalTower> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/capital_tower.jpg',
                            height: 360,
                            fit: BoxFit.cover,
