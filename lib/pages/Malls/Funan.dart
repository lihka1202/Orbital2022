...
class Funan extends StatefulWidget {
  const Funan({Key? key}) : super(key: key);

  @override
  State<Funan> createState() => _FunanState();
}

class _FunanState extends State<Funan> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/funan.jpg',
                            height: 360,
                            fit: BoxFit.cover,
