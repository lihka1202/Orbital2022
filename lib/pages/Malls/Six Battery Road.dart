...
class SixBatteryRoad extends StatefulWidget {
  const SixBatteryRoad({Key? key}) : super(key: key);

  @override
  State<SixBatteryRoad> createState() => _SixBatteryRoadState();
}

class _SixBatteryRoadState extends State<SixBatteryRoad> {
  Map data = {};
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(data['location'], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),),
          //centerTitle: true,
          elevation: 0,
        ),
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/six_battery.jpg',
                            height: 360,
                            fit: BoxFit.cover,
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          '6 Battery Road, Singapore, Singapore, 049909',
                ...
                child: Column(
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(hintText:'Enter Start Time (24hr format)', border: OutlineInputBorder()),
                    ),
                    MaterialButton(
                        onPressed: () {
                          //update startTime
                ...
                child: Column(
                  children: [
                    TextField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration: InputDecoration(hintText:'Enter End Time (24hr format)', border: OutlineInputBorder()),
                    ),
                    MaterialButton(
                        onPressed: () {
                          //update startTime
