...
class CapitalSpring extends StatefulWidget {
  const CapitalSpring({Key? key}) : super(key: key);

  @override
  State<CapitalSpring> createState() => _CapitalSpringState();
}

class _CapitalSpringState extends State<CapitalSpring> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/capital_spring.jpg',
                            height: 360,
                            fit: BoxFit.cover,
