...
class Junction8 extends StatefulWidget {
  const Junction8({Key? key}) : super(key: key);

  @override
  State<Junction8> createState() => _Junction8State();
}

class _Junction8State extends State<Junction8> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/junction_8.jpg',
                            height: 360,
                            fit: BoxFit.cover,
