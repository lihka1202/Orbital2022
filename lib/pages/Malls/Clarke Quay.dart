...
class ClarkeQuay extends StatefulWidget {
  const ClarkeQuay({Key? key}) : super(key: key);

  @override
  State<ClarkeQuay> createState() => _ClarkeQuayState();
}

class _ClarkeQuayState extends State<ClarkeQuay> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/clarke_quay.jpg',
                            height: 360,
                            fit: BoxFit.cover,
