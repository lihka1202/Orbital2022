...
class Westgate extends StatefulWidget {
  const Westgate({Key? key}) : super(key: key);

  @override
  State<Westgate> createState() => _WestgateState();
}

class _WestgateState extends State<Westgate> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/westgate.jpg',
                            height: 360,
                            fit: BoxFit.cover,
