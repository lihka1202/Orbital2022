...
class Jcube extends StatefulWidget {
  const Jcube({Key? key}) : super(key: key);

  @override
  State<Jcube> createState() => _JcubeState();
}

class _JcubeState extends State<Jcube> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/jcube.jpg',
                            height: 360,
                            fit: BoxFit.cover,
