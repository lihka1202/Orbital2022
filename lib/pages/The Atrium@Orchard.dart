...
class AtriumOrchard extends StatefulWidget {
  const AtriumOrchard({Key? key}) : super(key: key);

  @override
  State<AtriumOrchard> createState() => _AtriumOrchardState();
}

class _AtriumOrchardState extends State<AtriumOrchard> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/atrium_orchard.jpg',
                            height: 360,
                            fit: BoxFit.cover,
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          '60A Orchard Rd, Singapore 238890',
