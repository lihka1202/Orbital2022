...
class BukitPanjang extends StatefulWidget {
  const BukitPanjang({Key? key}) : super(key: key);

  @override
  State<BukitPanjang> createState() => _BukitPanjangState();
}

class _BukitPanjangState extends State<BukitPanjang> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/bukit_panjang.jpg',
                            height: 360,
                            fit: BoxFit.cover,
