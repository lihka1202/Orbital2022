...
class TampinesMall extends StatefulWidget {
  const TampinesMall({Key? key}) : super(key: key);

  @override
  State<TampinesMall> createState() => _TampinesMallState();
}

class _TampinesMallState extends State<TampinesMall> {
  Map data = {};
            ...
            children: <Widget>[
              Container(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                          child: Image.asset('assets/tampines_mall.jpg',
                            height: 360,
                            fit: BoxFit.cover,
